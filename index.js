...
console.log("Name of the first artist in the array is: " + artists[0].name);
console.log("Bio of the third artist in the array: " + artists[2].bio);
...
const newArtist = {
  ...
  bio: "Me fun, really really fun. And Me know jiu jitsu"
}
